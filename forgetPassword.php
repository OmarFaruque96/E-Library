<?php 
  ...
  if(isset($_POST['change_password_button'])){
      ...
      $query1 = "Select * from person where person_email = '$email'";
      $result = mysqli_query($conn,$query1);
    
      if(mysqli_num_rows($result) > 0){
        if($password==$confirm_password){
            $query2 = "UPDATE person SET person_password = '$password' WHERE person_email = '$email'";
...
<body>
	...
	<!-- sign up-->
		...
		<div class="container">
				<br>  <p class="text-center">Reset Your Password</a></p>
				<hr>

				<div class="card bg-light">
				<article class="card-body mx-auto" style="max-width: 400px;">
					<h4 class="card-title mt-3 text-center">Reset Your Account Password </h4>
					...
					<!-- form-group// -->
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" name="change_password_button" class="btn btn-primary btn-block">Reset Password</button>
                        
                        </div> <!-- form-group// -->      
                        <p class="text-center">Remerber Password ? <a href="login.php">Sign In</a></p>                                                                 
				    </form>
				</article>
				</div> <!-- card.// -->
