...
<?php
    ...
    if($session_data == ""){
        ...
        $query_topic_video_list = "Select video.*,person.person_name from course NATURAL JOIN topic NATURAL JOIN video NATURAL JOIN person Where video.topic_id = $topic_id and uploader_id = person.person_id";
        $result = mysqli_query($conn, $query_topic_video_list);
                ...
                <div class="col-12">
					...
					<!--Video Gallery-->
							<div class="col-md-10 col-md-offset-1">
								<h3 class="text-center" style="text-transform: uppercase"><?php echo $topic_name ?> Videos</h3>
