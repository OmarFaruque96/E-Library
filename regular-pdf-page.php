...
<body>
    ...
    <div class="regular-page-area section-padding-100">
		...
		<?php 
						$sql = "SELECT link FROM gallery WHERE type_id=2 AND pdf_title='Demo'";
            ...
            <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
					...
					<iframe class="embed-responsive-item" src="<?php echo "pdf notes/".$link ?>" frameborder="0"  width="100%" allowfullscreen> </iframe>
