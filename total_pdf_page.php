<?php
    ...
    if($session_data == ""){
        ...
        $query_full_pdf_list = "Select notes.*,person.person_name from course NATURAL JOIN topic NATURAL JOIN notes NATURAL JOIN person where course.course_id = $course_id and uploader_id = person.person_id";
        $result = mysqli_query($conn, $query_full_pdf_list);
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="container">
                        ...
                        <h1 class="font-weight-light text-center text-lg-left mt-4 mb-0"><?php echo $course_title ?> Topics Gallery</h1>
                        ...
                        <?php if(mysqli_num_rows($result) > 0){
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    $note_link = $row['notes_pdf_link'];
                        ?>
                            <div class="col-lg-3 col-md-4 col-6" align="center">

                                <img class="img-fluid img-thumbnail" src="img/book-cover.jpg" alt="">
                                <h6 class="text-center my-3"><?php echo $note_title ?><br>#Uploaded By <?php echo $person_name ?></h6>
                                <label></label>
                                <div style="padding: 10px 10px">
                                    <a class="btn btn-md-4 btn-success" href="<?php $note_link ?>">Download</a>
                                </div>
