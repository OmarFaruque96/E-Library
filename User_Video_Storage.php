                ...
                <div class="col-12">
					...
					<!--Video Gallery-->
							<div class="col-md-10 col-md-offset-1">
								<h3 class="text-center">C Programming Video Gallery</h3>
								<div class="row pb-row">
                                <?php
                                    $sql = "SELECT * FROM gallery WHERE type_id=1 AND person_mail='$session_data'";
                                ...
                                ?>
								    <div class="col-md-3 pb-video">
										<iframe class="pb-video-frame" width="100%" height="230" src="https://www.youtube.com/embed/<?php echo $video['content'] ?>" frameborder="0" allowfullscreen></iframe>
